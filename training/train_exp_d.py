...
def train(config_path: str):
    ...
    # Setup logger
    logger = setup_logger("train_exp_d", log_dir=log_cfg["log_dir"])
    logger.info(f"Starting Experiment D (Spatially-Aware MoE) training for {model_cfg['name']} on {dataset_cfg['name']} dataset.")
    ...
    for epoch in range(1, epochs_to_run + 1):
        ...
        # EXPERIMENT D DIAGNOSTICS: Print Expert Utilization
        total_counts = None

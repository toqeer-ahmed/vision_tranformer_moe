...
try:
    ...
    from vision_transformer_research.models.swin import SwinSegmentation
    ...
    from models.swin import SwinSegmentation
...
def train(config_path: str):
    ...
    experiment_dir = os.path.join("outputs", f"swin_vanilla_{timestamp}")
    ...
    # Setup logger
    logger = setup_logger("swin_vanilla", log_dir=log_dir)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Vanilla Swin Semantic Segmentation")

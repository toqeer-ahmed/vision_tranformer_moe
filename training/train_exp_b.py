...
def train(config_path: str):
    ...
    # Setup logger
    logger = setup_logger("train_exp_b", log_dir=log_cfg["log_dir"])
    logger.info(f"Starting Experiment B (MLP without Conv) training for {model_cfg['name']} on {dataset_cfg['name']} dataset.")
